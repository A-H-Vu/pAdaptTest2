...
expName = 'pAdaptTest2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\p-adapt-test2\\pAdaptTest2_lastrun.py',
...
for thisTrials2 in trials2:
    ...
    while continueRoutine:
        ...
        if trial2Cursor.status == STARTED:  # only update if drawing
            trial2Cursor.setPos(((trial2Mouse.getPos()[0]*cos(q))-(trial2Mouse.getPos()[1]*sin(q)), (trial2Mouse.getPos()[0]*sin(q))+(trial2Mouse.getPos()[1]*cos(q))), log=False)
